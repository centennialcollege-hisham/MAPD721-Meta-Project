 ...
 */
public abstract class Hilt_ChatBotFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ChatBotFragment() {
    super();
  }

  Hilt_ChatBotFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChatBotFragment_GeneratedInjector) this.generatedComponent()).injectChatBotFragment(UnsafeCasts.<ChatBotFragment>unsafeCast(this));
    }
  }
