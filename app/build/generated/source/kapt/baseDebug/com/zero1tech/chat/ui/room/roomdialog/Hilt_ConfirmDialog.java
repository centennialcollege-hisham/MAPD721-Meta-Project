 ...
 */
public abstract class Hilt_ConfirmDialog extends AppCompatDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ConfirmDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConfirmDialog_GeneratedInjector) this.generatedComponent()).injectConfirmDialog(UnsafeCasts.<ConfirmDialog>unsafeCast(this));
    }
  }
