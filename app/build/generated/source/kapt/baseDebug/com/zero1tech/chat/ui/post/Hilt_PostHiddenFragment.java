 ...
 */
public abstract class Hilt_PostHiddenFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PostHiddenFragment() {
    super();
  }

  Hilt_PostHiddenFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PostHiddenFragment_GeneratedInjector) this.generatedComponent()).injectPostHiddenFragment(UnsafeCasts.<PostHiddenFragment>unsafeCast(this));
    }
  }
