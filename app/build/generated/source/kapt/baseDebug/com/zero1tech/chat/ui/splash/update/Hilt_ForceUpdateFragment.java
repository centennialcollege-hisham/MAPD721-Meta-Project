 ...
 */
public abstract class Hilt_ForceUpdateFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ForceUpdateFragment() {
    super();
  }

  Hilt_ForceUpdateFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ForceUpdateFragment_GeneratedInjector) this.generatedComponent()).injectForceUpdateFragment(UnsafeCasts.<ForceUpdateFragment>unsafeCast(this));
    }
  }
