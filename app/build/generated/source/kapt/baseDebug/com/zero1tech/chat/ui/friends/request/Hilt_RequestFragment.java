 ...
 */
public abstract class Hilt_RequestFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RequestFragment_GeneratedInjector) this.generatedComponent()).injectRequestFragment(UnsafeCasts.<RequestFragment>unsafeCast(this));
    }
  }
