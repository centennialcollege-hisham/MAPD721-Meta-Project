 ...
 */
public abstract class Hilt_RoomFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RoomFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RoomFragment_GeneratedInjector) this.generatedComponent()).injectRoomFragment(UnsafeCasts.<RoomFragment>unsafeCast(this));
    }
  }
