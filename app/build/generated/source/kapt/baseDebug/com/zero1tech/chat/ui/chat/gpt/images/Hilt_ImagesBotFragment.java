 ...
 */
public abstract class Hilt_ImagesBotFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImagesBotFragment() {
    super();
  }

  Hilt_ImagesBotFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImagesBotFragment_GeneratedInjector) this.generatedComponent()).injectImagesBotFragment(UnsafeCasts.<ImagesBotFragment>unsafeCast(this));
    }
  }
