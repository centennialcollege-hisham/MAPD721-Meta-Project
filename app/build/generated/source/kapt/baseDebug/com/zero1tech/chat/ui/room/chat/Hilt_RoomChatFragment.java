 ...
 */
public abstract class Hilt_RoomChatFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RoomChatFragment() {
    super();
  }

  Hilt_RoomChatFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RoomChatFragment_GeneratedInjector) this.generatedComponent()).injectRoomChatFragment(UnsafeCasts.<RoomChatFragment>unsafeCast(this));
    }
  }
