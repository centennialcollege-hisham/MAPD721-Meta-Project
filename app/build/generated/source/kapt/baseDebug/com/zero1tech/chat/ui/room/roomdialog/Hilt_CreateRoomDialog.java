 ...
 */
public abstract class Hilt_CreateRoomDialog extends AppCompatDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreateRoomDialog() {
    super();
  }

  Hilt_CreateRoomDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateRoomDialog_GeneratedInjector) this.generatedComponent()).injectCreateRoomDialog(UnsafeCasts.<CreateRoomDialog>unsafeCast(this));
    }
  }
