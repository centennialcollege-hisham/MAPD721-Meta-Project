 ...
 */
public abstract class Hilt_AddPostFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddPostFragment() {
    super();
  }

  Hilt_AddPostFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddPostFragment_GeneratedInjector) this.generatedComponent()).injectAddPostFragment(UnsafeCasts.<AddPostFragment>unsafeCast(this));
    }
  }
