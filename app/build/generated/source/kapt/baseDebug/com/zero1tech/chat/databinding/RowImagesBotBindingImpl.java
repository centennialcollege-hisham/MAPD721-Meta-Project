...
public class RowImagesBotBindingImpl extends RowImagesBotBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.parent_left, 3);
        sViewsWithIds.put(R.id.rv_images, 4);
        sViewsWithIds.put(R.id.parent_right, 5);
    }
    // views
    @NonNull
    ...
    public RowImagesBotBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private RowImagesBotBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
