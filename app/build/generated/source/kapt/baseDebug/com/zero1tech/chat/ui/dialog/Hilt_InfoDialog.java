 ...
 */
public abstract class Hilt_InfoDialog extends AppCompatDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InfoDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InfoDialog_GeneratedInjector) this.generatedComponent()).injectInfoDialog(UnsafeCasts.<InfoDialog>unsafeCast(this));
    }
  }
