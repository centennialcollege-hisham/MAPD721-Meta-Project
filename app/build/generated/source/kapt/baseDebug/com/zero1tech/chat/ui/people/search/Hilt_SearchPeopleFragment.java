 ...
 */
public abstract class Hilt_SearchPeopleFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchPeopleFragment_GeneratedInjector) this.generatedComponent()).injectSearchPeopleFragment(UnsafeCasts.<SearchPeopleFragment>unsafeCast(this));
    }
  }
