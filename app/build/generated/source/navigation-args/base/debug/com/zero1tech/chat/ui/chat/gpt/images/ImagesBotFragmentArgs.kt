...
public data class ImagesBotFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): ImagesBotFragmentArgs {
      bundle.setClassLoader(ImagesBotFragmentArgs::class.java.classLoader)
      ...
      return ImagesBotFragmentArgs(__user, __fromSuggest, __flag, __receiverID)
    }
  }
}
