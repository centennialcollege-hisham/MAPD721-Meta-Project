...
public final class FragmentRequestBinding implements ViewBinding {
  ...
  private FragmentRequestBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView rvUser) {
  ...
  public static FragmentRequestBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRequestBinding((ConstraintLayout) rootView, rvUser);
    }
