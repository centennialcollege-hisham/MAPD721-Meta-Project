...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  private FragmentSplashBinding(@NonNull ConstraintLayout rootView, @NonNull CoordinatorLayout cl,
      @NonNull AppCompatImageView ivLogo, @NonNull ProgressBar progressBar,
      @NonNull AppCompatTextView tvVersion) {
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.cl;
      CoordinatorLayout cl = ViewBindings.findChildViewById(rootView, id);
      if (cl == null) {
        break missingId;
      }
      ...
      return new FragmentSplashBinding((ConstraintLayout) rootView, cl, ivLogo, progressBar,
          tvVersion);
    }
